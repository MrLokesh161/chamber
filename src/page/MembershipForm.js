    ...
    <div className="flex flex-col bg-white">
      ...
      <div className="flex items-center mb-2">
        ...
        <input 
          ...
          className="border border-solid border-stone-500 px-2 py-2 rounded-xl" />
      </div>

        
        <div className="flex flex-col w-[30%] max-md:ml-0 max-md:w-full">
          <div>
            <label className="text-base font-bold mb-2">2. Constitution</label>
            <img
              loading="lazy"
              src={know}
              className="self-stretch max-w-full aspect-[2.5] w-[329px]"
          ...
          <input type="text" className="border border-solid border-stone-900 px-3 py-2 mb-4" />
        </div>
